...
const musicData = [
  {
    backgroundImage: "assets/images/1.webp",
    ...
    year: 2021,
    artist: "Jordan Peterson",
    musicPath: "assets/music/1.mp3",
  },
  {
    backgroundImage: "assets/images/2.webp",
  ...
  },
  {
    ...
    year: 2022,
    artist: "Dr. Emily Harper",
    musicPath: "assets/music/3.mp3",
  },
  {
    backgroundImage: "assets/images/4.webp",
...
// Create a new URL object and extract the search parameters
const urlParams = new URLSearchParams(window.location.search);

// Get the 'id' parameter from the URL
const index = urlParams.get('index');

let currentMusic = index??0;
...
const initialLoadPlayerInfo=function ()
{
